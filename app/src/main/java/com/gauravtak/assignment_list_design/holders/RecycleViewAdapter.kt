...
class RecycleViewAdapter(private var rowsBeanList: ArrayList<RowsBean?>)
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        val dataBean: RowsBean = rowsBeanList[position]!!
    ...
    fun setData(data: ArrayList<RowsBean?>) {
